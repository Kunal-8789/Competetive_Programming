...
void solution()
{
    ...
    if (hour < 23)
    {
        if (hour == 5 or hour == 15)
        {
            ...
            {
                int y=(hour == 5 ? 10 : 20),z=(hour== 5?1:2);
                cout << (60 * (y - hour - 1) + 60 - min+z );
            }
        }

        else if (((hour >= 0 and hour < 5) or (hour >= 10 and hour < 15) or (hour >= 20)))
        {
            if (min <= temp)
                cout << temp - min;
            else
        ...
        else
        {
            ...
            if (hour < 10)
            {
                cout << (60 * (10 - hour - 1) + 60 - min+z);
            }
            else
            {
                cout << (60 * (20 - hour - 1) + 60 - min+z);
            }
        }
    }
    else
